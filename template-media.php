...
<main class="main">
    ...
    <section class="media">
        <div class="container">
            <div class="media-box" style="background: url('<?php the_field('smi_izobrazhenie');?>') no-repeat;">
                <h1 class="media-box__title title-page">
                    <?php the_field('smi_zagolovok');?>
                </h1>
            </div>

            <div class="media__inner">
                <?php if(have_rows('smi_kartochka')) : while(have_rows('smi_kartochka')) : the_row()?>
                <div class="media-block">
                    <div class="media-block__img">
                        <img src="<?php the_sub_field('smi_kartochka_kartinka');?>" alt="img">
                    </div>
                    <?php if(have_rows('smi_kartochka_element')) : while(have_rows('smi_kartochka_element')) : the_row()?>
                    <div class="media-block__item">
                        <div class="media-block__item-text">
                            <?php the_sub_field('smi_kartochka_element_tekst');?>
                        </div>
                        <a href="<?php the_sub_field('smi_kartochka_element_fajl');?>" class="media-block__item-link" download="file">
                            <img src="<?php echo get_template_directory_uri()?>/assets/images/media/media-link.svg" alt="img" class="media-block__item-img">
                        </a>    
                    </div>
                    <?php endwhile; endif;?>
                </div>
