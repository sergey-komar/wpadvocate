    ...
    <div class="container">
        ...
        <div class="container">
                ...
                <div class="category-block">
                    ...
                    <?php $category_image = get_field('izobrazhenie_rubriki', $cat)?>
                            <?php if ($query->have_posts()) : ?>
                                <div class="category-block__item">
                                    <div class="category-block__wrraper">
                                        ...
                                        <a href="<?php echo get_term_link($cat);?>" class="category-block__item-title">
                                        <?php echo $cat->name; ?>
                                        </a>
                                    </div>
                                    <?php while ($query->have_posts()) : $query->the_post(); ?>
                                    <div class="category-block__list">
                                    <a class="category-block__list-item" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                    </div>   
