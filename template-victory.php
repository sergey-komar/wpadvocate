...
<main class="main">
  ...
  <section class="victory">
   <div class="container">
       <div class="victory-box" style="background: url('<?php the_field('pobedy_izobrazhenie');?>') no-repeat;">
           <div class="victory-box__inner">
               <h1 class="victory-box__title title-page">
                <?php the_field('pobedy_zagolovok');?>
               </h1>
               <p class="victory-box__subtitle">
                <?php the_field('pobedy_podzagolovok');?>
               </p>
               <p class="victory-box__text">
                <?php the_field('pobedy_tekst');?>
               </p>
           </div>
       </div>

       <div class="victory-block">
            <?php if(have_rows('pobedy_kartochka')) : while(have_rows('pobedy_kartochka')) : the_row()?>
           <div class="victory-block__item">
               <div class="victory-block__item-title">
               <?php the_sub_field('pobedy_kartochka_zagolovok');?>
               </div>
               <div class="victory-block__wrapper">
                    <?php if(have_rows('pobedy_kartochka_opisanie')) : while(have_rows('pobedy_kartochka_opisanie')) : the_row()?>
                   <div class="victory-block__item-text">
                        <?php the_sub_field('pobedy_kartochka_opisanie_tekst');?>
                   </div>
                   <?php endwhile; endif;?>
               </div>
           </div>
