...
<main class="main">
    ...
    <section class="advocate">
        <div class="container">
            <div class="advocate-block">
                <div class="advocate-block__inner">
                    <div class="advocate-block__img">
                        <img src="<?php the_field('advokat_izobrazhenie');?>" alt="img">
                    </div>
                    ...
                    <div class="advocate-block__content">
                        ...
                        <h1 class="advocate-block__content-title">
                            <?php the_field('advokat_zagolovok');?>
                        </h1>
                        ...
                        <div class="advocate-block__social">
                            ...
                            <?php the_field('advokat_telefon');?>
                            </a>
                            <a href="mailto:stanislav@drobotov.net" class="advocate-block__social-link email">
                            <?php the_field('advokat_pochta');?>
                            </a>
                        </div>

                        <div class="advocate-block__subtitle">
                            <?php the_field('advokat_praktika_zagolovok');?>
                        </div>
                        <div class="advocate-block__info">
                            <?php if(have_rows('advokat_praktika_spisok')) : while(have_rows('advokat_praktika_spisok')) : the_row();?>
                           <div class="advocate-block__info-text">
                           <?php the_sub_field('advokat_praktika_spisok_tekst');?>
                           </div>
                           <?php endwhile; endif;?>
                        </div>
                        ...
                        <div class="advocate-block__subtitle">
                        <?php the_field('advokat_interesy_zagolovok');?>
                        </div>

                        <div class="advocate-block__interest">
                            <?php if(have_rows('advokat_interesy_spisok')) : while(have_rows('advokat_interesy_spisok')) : the_row();?>
                            <div class="advocate-block__interest-item">
                                <img src="<?php the_sub_field('advokat_interesy_spisok_kartinka');?>" alt="img">
                            </div>
                            <?php endwhile; endif;?>
                        </div>
                    </div>
            ...
            <div class="advocate-business">
                <div class="advocate-business__img">
                    <img src="<?php the_field('vizitka_kartinka');?>" alt="img">
                </div>
                <a href="<?php the_field('vizitka_skachat');?>" class="advocate-business__link" download>Скачать визитку</a>
            </div>
 
            <div class="advocate-education">
                <h3 class="advocate-education__title">Образование</h3>
                <div class="advocate-education__tabs">
                    <div class="advocate-education__inner">
                        <?php if(have_rows('obrazovanie_informacziya')) : while(have_rows('obrazovanie_informacziya')) : the_row();?>
                        <div class="advocate-education__item advocate-education__item--active">
                        <?php the_sub_field('obrazovanie_informacziya_zagolovok');?>
                            <div class="advocate-education__wrapper">
                                <div class="advocate-education__item-text">
                                <?php the_sub_field('obrazovanie_informacziya_dokument');?>
                                </div>
                                <a href="<?php the_sub_field('obrazovanie_informacziya_skachat');?>" class="advocate-education__item-link" download></a>
                            </div>
                        </div>
                        <?php endwhile; endif;?>
                    </div>
                   
                    <div class="advocate-education__content">
                        <?php if(have_rows('obrazovanie_kartinki')) : while(have_rows('obrazovanie_kartinki')) : the_row();?>
                        <div class="advocate-education__content-img">
                            <img src="<?php the_sub_field('obrazovanie_kartinki_dokument');?>" alt="img">
                        </div>
                        <?php endwhile; endif;?>
                    </div>
                </div>
            ...
            <div class="advocate-thanks">
                ...
                <div class="advocate-thanks__tabs">
                    <div class="advocate-thanks__inner">
                        <?php if(have_rows('blagodarnosti_informacziya')) : while(have_rows('blagodarnosti_informacziya')) : the_row();?>
                        <div class="advocate-thanks__item advocate-thanks__item--active">
                        <?php the_sub_field('blagodarnosti_informacziya_zagolovok');?>
                            <div class="advocate-thanks__wrapper">
                                <div class="advocate-thanks__item-text">
                                <?php the_sub_field('blagodarnosti_informacziya_dokument');?>
                                </div>
                                <a href="<?php the_sub_field('blagodarnosti_informacziya_skachat');?>" class="advocate-thanks__item-link" download></a>
                            </div>
                        </div>
                        <?php endwhile; endif;?>
                    </div>
                    ...
                    <div class="advocate-thanks__content">
                        <?php if(have_rows('blagodarnosti_kartinka')) : while(have_rows('blagodarnosti_kartinka')) : the_row();?>
                        <div class="advocate-thanks__content-img">
                            <img src="<?php the_sub_field('blagodarnosti_kartinka_dokument');?>" alt="">
                        </div>
                        <?php endwhile; endif;?>
                    </div>
                </div>
            ...
            <div class="advocate-career">
                <h3 class="advocate-career__title">
                    <?php the_field('karera_zagolovok');?>
                </h3>
                <div class="advocate-career__content">
                    <div class="advocate-career__content-title">
                    <?php the_field('karera_podzagolovok');?>
                    </div>
                    <?php if(have_rows('karera_spisok')) : while(have_rows('karera_spisok')) : the_row();?>
                    <div class="advocate-career__content-text">
                        <p>
                        <?php the_sub_field('karera_spisok_tekst');?>
                        </p>
                    </div>
                    <?php endwhile; endif;?>
                </div>
            ...
            <div class="advocate-gratitude">
                <h3 class="advocate-gratituder__title">
                <?php the_field('vyrazhayu_zagolovok');?>
                </h3>
                <div class="advocate-gratitude__content">
                    <div class="advocate-gratitude__content-title">
                    <?php the_field('vyrazhayu_podzagolovok');?>
                    </div>
                    <?php if(have_rows('vyrazhayu_spisok')) : while(have_rows('vyrazhayu_spisok')) : the_row();?>
                    <div class="advocate-gratitude__content-text">
                        <p>
                        <?php the_sub_field('vyrazhayu_spisok_tekst');?>
                        </p>
                    <?php endwhile; endif;?>
                    </div>
                </div>
